...
(Forme spécifique du modèle qu'on émet l'hypothèse)

---
### Sélection des pairs
(Expliquer les 3 critères selon nos résultats)
...
(Vector BT pro - À arranger)

### Résultats
(Insérer une analyse de nos résultats)

---

### Améliorations
- Est-ce que nos erreurs de notre forme spécifique suivent une distribution de loi normale
- Temps de calcul trop volumineux

---

## Étude hypothèses du modèle